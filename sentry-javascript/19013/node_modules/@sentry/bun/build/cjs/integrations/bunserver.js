...
function wrapRequestHandler(
  ...
  return core.withIsolationScope(isolationScope => {
    ...
    Object.assign(
      attributes,
      core.httpHeadersToSpanAttributes(request.headers.toJSON(), core.getClient()?.getOptions().sendDefaultPii ?? false),
    );
